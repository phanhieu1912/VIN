...
const NewsSlider = () => {
  ...
  return (
    <div className="max-w-[1200px] mx-auto flex flex-col gap-8">
      {/* Tiêu đề */}
      <h2 className="text-3xl sm:text-4xl font-bold text-yellow-500">Sự kiện & Bài viết</h2>
        ...
        >
          {news.map((item, index) => (
            <a key={index} href={item.link} className="w-[calc(100%/3)] sm:w-[calc(100%/3)] px-2 flex-shrink-0">
              <div className="bg-black/50 rounded-lg overflow-hidden border border-yellow-500 hover:border-yellow-300 transition">
                {/* Hình ảnh */}
                ...
                <div className="p-4">
                  ...
                  <h3 className="text-sm sm:text-lg font-semibold text-white line-clamp-2 min-h-[3rem]">
                    {item.title}
                  </h3>
